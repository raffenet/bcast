...
def check_destination_exists(dest_path):
    """Check if destination exists and prompt for overwrite if needed."""
    if os.path.exists(dest_path):
        print(f"Warning: Destination '{dest_path}' already exists.")
...
def main():
    ...
    if not args.force:
        check_destination_exists(dest_path)
